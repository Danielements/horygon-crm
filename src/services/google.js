...
seedSetting.run('sdi.company.country', 'IT', 'string');
seedSetting.run('sdi.company.vat', '', 'string');
seedSetting.run('sdi.company.fiscal_code', '', 'string');
...
seedSetting.run('sdi.production.client_cert_path', `${sdiDir}/prod/client.cer`, 'string');
seedSetting.run('sdi.production.client_key_path', `${sdiDir}/prod/client.key`, 'string');
seedSetting.run('sdi.production.server_cert_path', `${sdiDir}/prod/server.cer`, 'string');
seedSetting.run('sdi.production.server_key_path', `${sdiDir}/prod/server.key`, 'string');
seedSetting.run('sdi.production.ca_path', `${sdiDir}/prod/ca.cer`, 'string');
seedSetting.run('sdi.production.remote_server_cert_path', `${sdiDir}/prod/servizi.fatturapa.it.cer`, 'string');
seedSetting.run('sdi.production.remote_client_public_cert_path', `${sdiDir}/prod/Sistema_Interscambio_Fattura_PA.cer`, 'string');
seedSetting.run('sdi.test.ca_path', `${sdiDir}/test/caentrate.cer`, 'string');
seedSetting.run('sdi.test.remote_server_cert_path', `${sdiDir}/test/testservizi.fatturapa.it.cer`, 'string');
seedSetting.run('sdi.test.remote_client_public_cert_path', `${sdiDir}/test/SistemaInterscambioFatturaPATest.cer`, 'string');
seedSetting.run('sdi.csr.client_path', `${sdiDir}/csr/client.csr`, 'string');
seedSetting.run('sdi.csr.server_path', `${sdiDir}/csr/server.csr`, 'string');
